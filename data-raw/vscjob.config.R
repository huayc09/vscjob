...
vsc.config <- list(
  ...
  pbs.project = "lp_vsc32982",
  pbs.nodes = "1",
  pbs.ppn = "36",
  pbs.email = "yichao.hua@kuleuven.be",
  ...
  cellranger.program.path = "${VSC_DATA}/CellRanger/cellranger-5.0.1",
  cellranger.ref.mouse = "${VSC_SCRATCH}/TRANSFER/refdata-gex-mm10-2020-A",
  cellranger.ref.human = "${VSC_DATA}/CellRanger/cellranger-3.0.2/refdata-cellranger-GRCh38-3.0.0"
)
